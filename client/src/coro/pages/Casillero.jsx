...
import CasilleroTable from "../components/shared/CasilleroTable.jsx";
  ...
  return (
    <div className="bg-gray-50 flex flex-col min-h-screen pt-[150px]">
      ...
      <div className="flex-grow container mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Casilleros</h1>
        <CasilleroTable refreshTrigger={refreshTable} />
      </div>
